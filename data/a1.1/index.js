module.exports = {
  ...
  einheiten: [
    ...
    require('./03-text'),       // Lesetext: Erste Begegnung
    ...
    require('./06-text'),       // Lesetext: Im Café
    ...
    require('./09-text'),       // Lesetext: Meine Familie
    ...
    require('./12-text'),       // Lesetext: In der Stadt
    ...
    require('./13-text'),       // Lesetext: Ein ganz normaler Tag
