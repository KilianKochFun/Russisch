module.exports = {
  typ: `grammatik`,
  titel: `Nullkopula & Pronomen`,
  fragen: [
    {
      q: `Wie lautet „Ich bin Student" auf Russisch?`,
      a: [`Я есть студент`, `Я являюсь студент`, `Я студент`],
      c: 2,
      m: `Im russischen Präsens entfällt быть (sein) komplett: Я студент, он врач, она учитель.`
    },
    {
      q: `Was ist das russische Pronomen für „wir"?`,
      a: [`вы`, `мы`, `они`],
      c: 1,
      m: `Personalpronomen: я (ich), ты (du), он/она/оно (er/sie/es), мы (wir), вы (ihr/Sie), они (sie Pl.)`
    },
    {
      q: `Wie sagt man „Sie sind Ärztin" (formell)?`,
      a: [`Вы есть врач`, `Вы врач`, `Ты врач`],
      c: 1,
      m: `вы = Sie (formell) oder ihr (Plural). Das Verb быть entfällt: Вы врач = Sie sind Ärztin.`
    },
    {
      q: `Welches Pronomen für eine gemischte Gruppe (Männer + Frauen)?`,
      a: [`он`, `она`, `они`],
      c: 2,
      m: `они = sie (Plural) — für Gruppen aus Menschen jedes Geschlechts, auch für Sachen im Plural.`
    },
    {
      q: `Wie fragt man „Was ist das?" auf Russisch?`,
      a: [`Кто это?`, `Что это?`, `Это что?`],
      c: 1,
      m: `Что это? = Was ist das? — für Sachen. Кто это? = Wer ist das? — für Personen.`
    },
    {
      q: `Wie sagt man „Das ist meine Apotheke"?`,
      a: [`Это есть моя аптека`, `Это моя аптека`, `Это мой аптека`],
      c: 1,
      m: `Это моя аптека — kein Verb, und аптека ist feminin → моя (nicht мой).`
    },
    {
      q: `„Он" oder „она" — was passt zu „аудитория"?`,
      a: [`он`, `она`, `оно`],
      c: 1,
      m: `аудитория endet auf -ия → feminin → она. Alle Nomen auf -а/-я sind fast immer feminin.`
    },
    {
      q: `Welches grammatische Geschlecht hat „стол" (Tisch)?`,
      a: [`männlich`, `weiblich`, `sächlich`],
      c: 0,
      m: `Nomen auf Konsonant ohne -а/-я/-о/-е sind fast immer männlich: стол, дом, брат, город.`
    },
    {
      q: `Welches grammatische Geschlecht hat „окно" (Fenster)?`,
      a: [`männlich`, `weiblich`, `sächlich`],
      c: 2,
