# Grammatik-Karte — Wo ist was?

Übersicht über alle eingeführten Grammatik-Themen nach Kapitel und Datei.

---

## A1.1 — Erste Kontakte

| Datei | Typ | Grammatik-Thema | Inhalt |
|---|---|---|---|
...
## A1.2 — Akkusativ & Bewegungsverben

| Datei | Typ | Grammatik-Thema | Inhalt |
|---|---|---|---|
| `02-theorie` | Theorie | Akkusativ — 4. Kasus | Überblick 6 Kasus · f. -а→-у · m. unbelebt = unverändert · m. belebt +а · n. = unverändert · transitive Verben (читать/видеть/любить/знать/слышать/понимать/ждать/купить) |
...
Geplant laut CLAUDE.md: Genitiv (Besitz, нет, у, Mengen, Zahlen) + Dativ (Adressat, Alter, нравиться) + Demonstrativpronomen

---

## A1.4 — TODO

Geplant laut CLAUDE.md: Instrumental + Präteritum + Aspektpaar + Futur + Imperativ + можно/нельзя/должен

---

## Kasus-Übersicht: Was ist wo eingeführt?

| Kasus | Status | Eingeführt in | Schwerpunkt |
|---|---|---|---|
| Nominativ | ✅ vollständig | A1.1 (überall) | Subjekt, Prädikativ |
| Genitiv | ✅ teilweise | A1.1/05, A1.1/11, A1.2/04 | нет+Gen, у+Gen, из/с+Gen (Woher) · Vollausbau: A1.3 |
| Dativ | ⬜ TODO | — | A1.3 |
| Akkusativ | ✅ vollständig | A1.2/02 | direktes Objekt, Wohin (в/на+Akk.) |
| Instrumental | ⬜ TODO | — | A1.4 |
| Präpositiv | ✅ vollständig | A1.1/11 | Wo (в/на+Präp.) |

## Verbsystem-Übersicht: Was ist wo eingeführt?

| Thema | Status | Eingeführt in |
|---|---|---|
| Präsens 1./2. Konjugation | ✅ | A1.1/13 |
| Unregelmäßige Verben (хотеть, идти, быть) | ✅ | A1.1/13 |
| Konsonantenwechsel 1.Pers. (писать, любить, видеть) | ✅ | A1.1/13 |
| Bewegungsverben идти/ходить/ехать/ездить | ✅ | A1.2/04 |
| Perfektiver Aspekt пойти/поехать (Einführung) | ✅ teilweise | A1.2/04 |
| Präteritum (читал/читала) | ⬜ TODO | A1.4 |
| Futur (буду читать) | ⬜ TODO | A1.4 |
| Imperativ | ⬜ TODO | A1.4 |
| Vollständiger Aspekt imperfektiv/perfektiv | ⬜ TODO | A2 |
